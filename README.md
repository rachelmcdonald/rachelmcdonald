...
### Tech stack
`Python` `Flask` `TypeScript` `JavaScript` `React` `Java` `PostgreSQL` `AWS` `Docker` `Playwright` `Git`
...
I care about inclusive tech — I volunteered with Code First Girls teaching web 
